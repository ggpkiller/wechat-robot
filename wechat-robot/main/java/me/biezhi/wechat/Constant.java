...
public class Constant {
	...
	//是否抢答时间
	private static boolean answerEnable = false;
	
	public static synchronized boolean getOrSetAnserEnable(boolean answerEnable){
		Constant.answerEnable = answerEnable;
		return Constant.answerEnable;
	}
}
